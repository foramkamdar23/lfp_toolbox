%% CPEEG02 - LFP loading & preprocessing
...
%% ===================== LOAD PERCEPT LFP =====================
lfp_first_file  = "C:\Users\fkamdar\Desktop\repos\data\cp\sub-cpeeg02\ses-02-selected\ieeg\Report_Json_Session_Report_1209.mat";
lfp_second_file = "C:\Users\fkamdar\Desktop\repos\data\cp\sub-cpeeg02\ses-02-selected\ieeg\Report_Json_Session_Report_1226.mat";
...
lfp1_all = data1.data.IndefiniteStreaming;   % struct array, one entry per channel
...
bdf_file     = "C:\Users\fkamdar\Desktop\repos\data\eeg-selected\cpeeg02_b01_ert.bdf";
...
tens_band     = [75 85];   % Hz, bandpass around the 80 Hz TENS burst
tens_filt_ord = 4;
