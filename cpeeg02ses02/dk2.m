%% =========================================================================
% CPEEG02 — SECOND HALF (FINAL WITH TENS REMOVAL)
% =========================================================================
clear; clc; close all;
...
% =========================================================================
%% =========================================================================
% REMOVE SPECIFIC BAD TRIAL (TENS)
% =========================================================================
...
keep_trials = setdiff(1:length(data_out.trial), bad_trials);

data_out.trial = data_out.trial(keep_trials);
data_out.time  = data_out.time(keep_trials);

% also update trialinfo if present
if isfield(data_out, 'trialinfo')
    data_out.trialinfo = data_out.trialinfo(keep_trials);
end

fprintf('Removed trial(s): ');
disp(bad_trials);

fprintf('Remaining trials: %d\n', length(data_out.trial));
%% =========================================================================
% SAVE
% =========================================================================
save('lfp_secondhalf_clean.mat','data_out');
