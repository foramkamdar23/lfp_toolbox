...
align_channel   = "ZERO_TWO_LEFT";  % channel used to estimate the alignment lag

data1 = load(lfp_first_file);
data2 = load(lfp_second_file);
lfp1_all = data1.data.BrainSenseTimeDomain;   % struct array, one entry per channel
...
bdf_file =  "C:\Users\fkamdar\Desktop\repos\data\ok_new_cp\cpeeg01_ses02_ert_b03.bdf";
